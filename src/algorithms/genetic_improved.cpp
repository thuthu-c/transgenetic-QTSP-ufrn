...
GeneticImproved::GeneticImproved(
    int maxEvaluations,
    int populationSize,
    float crossoverRate,
    float mutationRate)
...
std::vector<int> GeneticImproved::getNearestNeighbors(int cityIndex, Graph &graph, int neighborNumber)
{
    int n = graph.getMaxM();
...
std::vector<std::vector<int>> GeneticImproved::initializeNearestNeighbors(int populationSize, Graph &graph)
{
    int cityIndex = 0;
...
std::vector<int> GeneticImproved::greedyPermuting(std::vector<int>& seedIndividual, Graph &graph, int n)
{
...
std::vector<std::vector<int>> GeneticImproved::initializeRandomPopulation(int populationSize, Graph &graph)
{
    std::vector<std::vector<int>> population;
...
std::vector<std::vector<int>> GeneticImproved::initializePopulation(Graph &graph)
{
...
// it uses tournament
std::pair<int, std::vector<int>> GeneticImproved::selectParent(
...
std::vector<int> GeneticImproved::generateOffspring(std::vector<int> &mother, std::vector<int> &father)
{
    int n = mother.size();
    int random1 = -1;
    int random2 = -1;
...
std::pair<int, std::vector<int>> GeneticImproved::crossover(
...
int GeneticImproved::eval(std::vector<int> &tour, Graph &graph)
{
    int tourVal = 0;
    int n = graph.getMaxM();
...
std::vector<int> GeneticImproved::mutate(std::vector<int> &individual)
{
...
std::vector<std::pair<int, std::vector<int>>> GeneticImproved::evaluatePopulation(std::vector<std::vector<int>> &population, Graph &graph)
{
...
std::vector<int> GeneticImproved::run(Graph &graph)
{
    this->numEvaluation = 0;
...
void GeneticImproved::setCrossverRate(float crossoverRate)
{
...
void GeneticImproved::setMutationRate(float mutationRate)
{
